...
def loaddatas(d_loader,d_name,spcial):
    ...
    elif d_loader=='Amazon' or d_loader=='Coauthor':
        dataset = getattr(dt, d_loader)('data/'+d_name,name=d_name)
    else:
        dataset = getattr(dt, d_loader)('data/'+d_name,d_name)
